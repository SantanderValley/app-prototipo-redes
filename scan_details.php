                        ...
                        <?php foreach($all_vulnerabilities as $vulnerability): ?>
                            ...
                            <div class="border rounded-lg overflow-hidden">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="mb-4">
                                        <div class="font-medium text-gray-700 mb-2">Dispositivos afectados:</div>
                                        <ul class="list-disc pl-5 text-sm space-y-1">
                                            <?php if (isset($vulnerability['affected_devices']) && is_array($vulnerability['affected_devices'])): ?>
                                                <?php foreach ($vulnerability['affected_devices'] as $device): ?>
                                                ...
                                                <?php endforeach; ?>
                                            <?php else: ?>
                                                <li class="text-gray-800">No se identificaron dispositivos específicos</li>
                                            <?php endif; ?>
                                        </ul>
                                    </div>
